...
%prep
%setup -q -n cchardet-2.1.6
cd %{_builddir}/cchardet-2.1.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602521461
...
cp %{_builddir}/cchardet-2.1.6/COPYING %{buildroot}/usr/share/package-licenses/cchardet/b43296a79ba94d20f8bf64837d7680856776337c
cp %{_builddir}/cchardet-2.1.6/src/ext/uchardet/COPYING %{buildroot}/usr/share/package-licenses/cchardet/b43296a79ba94d20f8bf64837d7680856776337c
